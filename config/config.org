...
*** Catppuccin
Catppuccin theme for emacs (uncomment if ewal is not possible).
#+begin_src emacs-lisp
...
*** Ewal
Changes theme dynamically with pywal16 color palette.
#+begin_src emacs-lisp
  (use-package ewal
    :ensure t
    :custom
...
#+begin_src emacs-lisp
  ...
  ;; Neotree
  (my-leader-def
    "n" '(neotree-toggle :wk "neotree file tree viewer"))
...
#+begin_src emacs-lisp
  ...
  (add-hook 'typescript-ts-mode 'englot-ensure)
  (add-hook 'js-ts-mode 'englot-ensure)
  (add-hook 'tsx-ts-mode 'englot-ensure)
#+end_src
...
#+begin_src emacs-lisp
  (use-package centaur-tabs
    ...
    ;; Cycle only through buffers from group
